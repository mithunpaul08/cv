...
\bigskip{\large \bf Mithun `Mitch' Paul }}
\end{center}
\smallskip
...
\\\vspace{.0cm}&Thesis: Knowledge Distillation as a possible solution for domain transfer. 
...
\item Mithun Paul Panenghat, Sandeep Suntwal and Mihai Surdeanu.   \ti{Students Who Student Together Learn Better: On the Importance of Collective Knowledge Distillation for Domain Transfer in Fact Verification}. In review at the\ve {The Joint Conference of the 59th Annual Meeting of the Association for Computational Linguistics and the 11th International Joint Conference on Natural Language Processing (ACL-IJCNLP 2021)}, 2021.


\item Mithun Paul Panenghat, Sandeep Suntwal and Mihai Surdeanu.   \ti{Data and Model Distillation as a Solution for Domain-transferable Fact Verification}. Accepted to the\ve {Conference of the North American Chapter of the Association for Computational Linguistics(NAACL)}, 2021.

\item Mithun Paul Panenghat, Sandeep Suntwal, Faiz Rafique, Rebecca Sharp, and Mihai Surdeanu.   \ti{Towards the Necessity for Debiasing Natural Language Inference Datasets}.  In \ve{the Proceedings of Language Resources and Evaluation Conference (LREC)}, 2020.
