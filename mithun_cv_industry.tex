...
\item Mithun Paul Panenghat, Sandeep Suntwal and Mihai Surdeanu.   \ti{Students Who Study Together Learn Better: On the Importance of Collective Knowledge Distillation for Domain Transfer in Fact Verification}. In review at \ve {The Joint Conference of the 59th Annual Meeting of the Association for Computational Linguistics and the 11th International Joint Conference on Natural Language Processing (ACL-IJCNLP 2021)}, 2021.



\item Mithun Paul Panenghat, Sandeep Suntwal and Mihai Surdeanu.   \ti{Data and Model Distillation as a Solution for Domain-transferable Fact Verification}. Accepted to  \ve{The Conference of the North American Chapter of the Association for Computational Linguistics(NAACL)}, 2021.
